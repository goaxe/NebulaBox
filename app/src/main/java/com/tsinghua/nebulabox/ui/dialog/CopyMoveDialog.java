...
public class CopyMoveDialog extends TaskDialog {
    ...
    protected void onDialogCreated(Dialog dialog) {
        ...
        AccountManager manager = new AccountManager(getActivity().getApplicationContext());
        SeafRepo repo = new DataManager(manager.getAccount()).getCachedRepoByID(ctx.dstRepoId);
        if (repo != null) {
